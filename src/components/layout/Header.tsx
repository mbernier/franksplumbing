  ...
  return (
    ...
    >
      <div className="container-custom flex justify-between items-center">
        ...
        <a 
          href="tel:7206482782" 
          className="hidden md:flex items-center bg-brand-red text-white px-4 py-2 rounded-full hover:bg-opacity-90 transition-all duration-200 phone-pulse"
        >
          <Phone className="mr-2 h-4 w-4" />
          <span className="font-semibold">(720) 648-2782</span>
        </a>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white shadow-md">
          <nav className="container-custom py-4 flex flex-col">
            ...
            <a 
              href="tel:7206482782" 
              className="flex items-center mt-4 bg-brand-red text-white px-4 py-2 rounded-full"
            >
              <Phone className="mr-2 h-4 w-4" />
              <span className="font-semibold">Call Now: (720) 648-2782</span>
            </a>
          </nav>
        </div>
      )}
